...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group relative inline-flex h-9 w-9 items-center justify-center rounded-xl border border-[color:var(--line-soft)] bg-[color:var(--surface-glass)] backdrop-blur-sm transition-all duration-300 hover:border-brand-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 dark:border-slate-700 dark:bg-slate-800/80 dark:hover:border-brand-500/50 dark:hover:shadow-[0_0_20px_rgba(59,130,246,0.25)]"
    >
