  ...
  const serviceOptions = [
    {
      ...
      code: "MONTAGE_KUECHE",
      nameDe: "Küchenmontage",
      descriptionDe: "Montage oder Teilmontage von Küchenzeilen.",
      pricingType: "PER_UNIT" as const,
      defaultPriceCents: 29900,
      defaultLaborMinutes: 180,
    ...
    },
    {
      ...
      nameDe: "Waschmaschine anschließen",
      descriptionDe: "Anschluss, Ausrichtung und Funktionsprüfung.",
      pricingType: "PER_UNIT" as const,
    ...
    },
    {
      ...
      descriptionDe: "Fachgerechter Anschluss inkl. Dichtigkeitscheck.",
      pricingType: "PER_UNIT" as const,
    ...
    },
    {
      ...
      nameDe: "Kühlschrank Einbau/Ausrichtung",
      descriptionDe: "Einbau und Ausrichtung von Kühlgeräten.",
      pricingType: "PER_UNIT" as const,
    ...
    },
    {
      moduleId: montageModule.id,
      code: "MONTAGE_MOEBEL",
      nameDe: "Schrank-/Möbelmontage",
      descriptionDe: "Montage von Schränken, Betten und Regalen.",
      pricingType: "PER_UNIT" as const,
    ...
    {
      moduleId: montageModule.id,
      code: "MONTAGE_DEMONTAGE",
      nameDe: "Demontage/Remontage",
      descriptionDe: "Abbau und Wiederaufbau bestehender Möbel.",
    ...
    },
    {
      ...
      nameDe: "Elektroaltgeräte",
      descriptionDe: "Abholung und fachgerechte Entsorgung von Elektrogeräten.",
      pricingType: "PER_UNIT" as const,
    ...
    },
    {
      ...
      nameDe: "Altmöbel",
      descriptionDe: "Entsorgung alter Möbel und Sperrgut.",
    ...
    },
    {
      ...
      nameDe: "Keller-/Abstellraum Räumung",
      descriptionDe: "Teil- oder Komplett-Räumung von Nebenräumen.",
      pricingType: "PER_HOUR" as const,
      defaultPriceCents: 7900,
      defaultLaborMinutes: 60,
      requiresQuantity: true,
    ...
    },
    {
      ...
      descriptionDe: "Teilweise oder komplette Wohnungsauflösung.",
      pricingType: "PER_M3" as const,
      defaultPriceCents: 6900,
      defaultLaborMinutes: 60,
      requiresQuantity: true,
    ...
    },
    {
      ...
      nameDe: "Gartenabfall/Grünschnitt",
      descriptionDe: "Entsorgung von Gartenabfällen und Grünschnitt.",
      pricingType: "PER_M3" as const,
      defaultPriceCents: 3900,
    ...
    {
      moduleId: entsorgungModule.id,
      code: "ENTSORGUNG_MISCHSPERRMUELL",
      nameDe: "Mischsperrmüll",
      descriptionDe: "Gemischte Sperrmüll-Abholung mit Sortierung.",
      pricingType: "PER_M3" as const,
